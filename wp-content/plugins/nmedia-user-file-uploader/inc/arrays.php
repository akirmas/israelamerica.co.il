...
function wpfm_array_cpt_meta() {
	...
	$cpt_meta['wpfm-files'] = array (
		'labels' => array (
				'name' 				 => __ ( 'User Files', 'wpfm' ),
				'singular_name' 	 => __ ( 'User Files', 'wpfm' ),
				'add_new' 			 => __('Add New', 'wpfm'),
				'all_items' 		 => __('All Files', 'wpfm'),
				'add_new_item' 		 => __('Add User Files', 'wpfm'),
				'edit' 				 => __('Edit', 'wpfm'),
				'edit_item' 		 => __('Edit User Files', 'wpfm'),
				'new_item' 			 => __('New User Files', 'wpfm'),
				'view' 				 => __('View', 'wpfm'),
				'view_item' 		 => __('View User Files', 'wpfm'),
				'search_items' 		 => __('Search User Files', 'wpfm'),
				'not_found' 		 => __('No User Files found', 'wpfm'),
				'not_found_in_trash' => __('No User Files found in Trash', 'wpfm'),
				'parent' 			 => __('Parent User Files', 'wpfm'),
