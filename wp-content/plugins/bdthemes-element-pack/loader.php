...
class Element_Pack_Loader {
	...
	public function register_site_scripts() {
		...
		wp_register_script( 'bdt-uikit-icons', BDTEP_URL . 'assets/js/bdt-uikit-icons' . $suffix . '.js', ['jquery', 'bdt-uikit'], '3.0.2', true );
		...
		wp_register_script( 'chart', BDTEP_URL . 'assets/vendor/js/chart' . $suffix . '.js', ['jquery'], '', true );
		...
		wp_register_script( 'timeline', BDTEP_URL . 'assets/vendor/js/timeline' . $suffix . '.js', ['jquery'], '', true );
		...
		wp_register_script( 'spritespin', BDTEP_URL . 'assets/vendor/js/spritespin' . $suffix . '.js', ['jquery'], '', true );
