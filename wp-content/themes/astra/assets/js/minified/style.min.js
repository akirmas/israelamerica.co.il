...
jQuery(function() {
	if(jQuery('body').hasClass('elementor-editor-active')) {	
		...
		jQuery('.tex_row_bl').each(function(i,elem) {
			jQuery('.elementor-1351 .elementor-inner .elementor-section-wrap .elementor-top-section-main:nth-child('+i+') .tex_row_bl').appendTo('.elementor-1351 .elementor-inner .elementor-section-wrap .elementor-top-section-main:nth-child('+i+') .elementor-tab-content');
			jQuery('.elementor-1351 .elementor-inner .elementor-section-wrap .elementor-top-section-main:nth-child('+i+') .img_row_bl').appendTo('.elementor-1351 .elementor-inner .elementor-section-wrap .elementor-top-section-main:nth-child('+i+') .elementor-tab-content');
			console.log('true');
		});
	}
});
